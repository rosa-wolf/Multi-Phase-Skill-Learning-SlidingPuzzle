...
nohup python3 sac-fm_training.py --env_name 2x2-new-penalty --num_skills 2 --relabeling > /dev/null 2>&1 &
nohup python3 sac-fm_training.py --env_name 2x2-new-penalty --num_skills 2 --sparse --relabeling > /dev/null 2>&1 &
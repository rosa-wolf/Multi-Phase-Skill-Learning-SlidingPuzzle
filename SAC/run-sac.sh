...
nohup python3 sac-train.py  --num_epochs 50000 --env_name skill_conditioned_3x3 --neg_dist --num_skills 4 > /dev/null 2>&1 &
nohup python3 sac-train.py  --num_epochs 50000 --env_name skill_conditioned_3x3 --neg_dist --reward_on_change --num_skills 4 > /dev/null 2>&1 &
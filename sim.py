...
if __name__ == '__main__':
    ...
    box_pos = (env.scene.C.getFrame("boxes" + str(env.box)).getPosition()).copy()
    print("init boxes pos = ", box_pos)
    ...
    dist, _ = env.scene.C.eval(ry.FS.distance, ["boxes" + str(env.box), "wedge"])
    print("dist = ", dist)
    print("=========================================")
    if box_pos[0] > 0:
        v = -0.2
